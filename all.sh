...
sh $script_path/config_lib.sh

sh $script_path/clean_yaml.sh

sh $script_path/config_time.sh

sh $script_path/config_crontab.sh

sh $script_path/run_images.sh
...
# fi
sh $script_path/run_alias_general.sh

sh $script_path/run_alias_car.sh

sh $script_path/run_clearzcfiles.sh
